...
Public Class rptRequisicion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptRequisicion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DescripcionBodega() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRequisicion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRequisicion = New rptRequisicion()
        rpt.Site = Me.Site
        Return rpt
    End Function
