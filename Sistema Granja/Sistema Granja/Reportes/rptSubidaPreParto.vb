...
Public Class rptSubidaPreParto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptSubidaPreParto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubidaPreParto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubidaPreParto = New rptSubidaPreParto()
        rpt.Site = Me.Site
        Return rpt
    End Function
