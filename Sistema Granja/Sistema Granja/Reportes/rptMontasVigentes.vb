...
Public Class rptMontasVigentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptMontasVigentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMontasVigentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMontasVigentes = New rptMontasVigentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
