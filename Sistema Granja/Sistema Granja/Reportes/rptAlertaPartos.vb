...
Public Class rptAlertaPartos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptAlertaPartos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlertaPartos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlertaPartos = New rptAlertaPartos()
        rpt.Site = Me.Site
        Return rpt
    End Function
