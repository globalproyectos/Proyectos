...
Public Class rptKardexHatos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptKardexHatos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKardexHatos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKardexHatos = New rptKardexHatos()
        rpt.Site = Me.Site
        Return rpt
    End Function
