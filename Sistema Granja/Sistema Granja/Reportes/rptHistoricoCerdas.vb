...
Public Class rptHistoricoCerdas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptHistoricoCerdas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoricoCerdas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoricoCerdas = New rptHistoricoCerdas()
        rpt.Site = Me.Site
        Return rpt
    End Function
