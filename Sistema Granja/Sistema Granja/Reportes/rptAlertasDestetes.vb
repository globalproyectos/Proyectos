...
Public Class rptAlertasDestetes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptAlertasDestetes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlertasDestetes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlertasDestetes = New rptAlertasDestetes()
        rpt.Site = Me.Site
        Return rpt
    End Function
