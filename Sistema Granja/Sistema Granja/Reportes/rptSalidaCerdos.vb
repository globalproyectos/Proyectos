...
Public Class rptSalidaCerdos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptSalidaCerdos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalidaCerdos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalidaCerdos = New rptSalidaCerdos()
        rpt.Site = Me.Site
        Return rpt
    End Function
