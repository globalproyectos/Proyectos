...
Public Class rptPesosLechones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptPesosLechones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPesosLechones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPesosLechones = New rptPesosLechones()
        rpt.Site = Me.Site
        Return rpt
    End Function
