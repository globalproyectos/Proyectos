...
Public Class rptAlertasMaximoPartos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAlertasMaximoPartos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptAlertasMaximoPartos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlertasMaximoPartos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlertasMaximoPartos = New rptAlertasMaximoPartos()
        rpt.Site = Me.Site
        Return rpt
    End Function
