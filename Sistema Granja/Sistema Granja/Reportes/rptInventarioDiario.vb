...
Public Class rptInventarioDiario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventarioDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptInventarioDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventarioDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventarioDiario = New rptInventarioDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
