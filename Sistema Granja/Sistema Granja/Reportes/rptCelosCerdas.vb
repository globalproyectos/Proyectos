...
Public Class rptCelosCerdas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptCelosCerdas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCelosCerdas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCelosCerdas = New rptCelosCerdas()
        rpt.Site = Me.Site
        Return rpt
    End Function
