...
Public Class rptNotaReingreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptNotaReingreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaReingreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaReingreso = New rptNotaReingreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
