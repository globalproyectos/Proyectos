...
Public Class rptCorteDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptCorteDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCorteDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCorteDiario = New rptCorteDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
