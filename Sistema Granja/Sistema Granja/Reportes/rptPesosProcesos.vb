...
Public Class rptPesosProcesos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptPesosProcesos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPesosProcesos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPesosProcesos = New rptPesosProcesos()
        rpt.Site = Me.Site
        Return rpt
    End Function
