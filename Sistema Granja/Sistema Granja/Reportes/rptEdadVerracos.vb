...
Public Class rptEdadVerracos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.rptEdadVerracos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEdadVerracos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEdadVerracos = New rptEdadVerracos()
        rpt.Site = Me.Site
        Return rpt
    End Function
