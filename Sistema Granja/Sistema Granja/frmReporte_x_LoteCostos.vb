...
Imports System.Data
Public Class frmReporte_x_LoteCostos
    ...
    Private Sub frmReporte_x_LoteCostos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CargarLotes(Me.CbxListaLotes)
        ...
        Dim dc11 As New DataColumn("Totales", System.Type.GetType("System.Decimal"))
        Dim dc12 As New DataColumn("///")
        Dim dc13 As New DataColumn("Reemplazos", System.Type.GetType("System.Int32"))
        Dim dc14 As New DataColumn("Defuncion", System.Type.GetType("System.Int32"))
        Dim dc15 As New DataColumn("Destazo", System.Type.GetType("System.Int32"))
        Dim dc16 As New DataColumn("Rastro", System.Type.GetType("System.Int32"))
        Dim dc17 As New DataColumn("Entrada", System.Type.GetType("System.Int32"))
        Dim dc18 As New DataColumn("Salida", System.Type.GetType("System.Int32"))
        Dim dc19 As New DataColumn("Total_Cerdos", System.Type.GetType("System.Int32"))
        ...
        'dc18.Expression = "(Reemplazos+Defuncion+Destazo+Rastro+Salida)-Entrada"
        ...
        Me.DgvDetallesCyC.Columns(1).Width = 55
        Me.DgvDetallesCyC.Columns(2).Width = 70
        Me.DgvDetallesCyC.Columns(3).Width = 70
        Me.DgvDetallesCyC.Columns(4).Width = 70
        Me.DgvDetallesCyC.Columns(5).Width = 70
        Me.DgvDetallesCyC.Columns(6).Width = 70
        Me.DgvDetallesCyC.Columns(7).Width = 70
        Me.DgvDetallesCyC.Columns(8).Width = 65
        Me.DgvDetallesCyC.Columns(9).Width = 60
        Me.DgvDetallesCyC.Columns(10).Width = 60
        Me.DgvDetallesCyC.Columns(11).Width = 65
        Me.DgvDetallesCyC.Columns(12).Width = 20
        Me.DgvDetallesCyC.Columns(13).Width = 71
        Me.DgvDetallesCyC.Columns(14).Width = 65
        Me.DgvDetallesCyC.Columns(15).Width = 65
        Me.DgvDetallesCyC.Columns(16).Width = 65
        Me.DgvDetallesCyC.Columns(17).Width = 65
        Me.DgvDetallesCyC.Columns(18).Width = 65
        Me.DgvDetallesCyC.Columns(19).Width = 73


        Me.DgvDetallesCyC.Columns(0).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(1).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(2).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(3).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(4).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(5).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(6).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(7).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(8).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(9).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(10).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(11).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(12).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
        Me.DgvDetallesCyC.Columns(13).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(14).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(15).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(16).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(17).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(18).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.DgvDetallesCyC.Columns(19).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        Me.DgvDetallesCyC.Columns(0).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(1).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(2).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(3).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(4).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(5).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(6).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(7).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(8).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(9).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(10).DefaultCellStyle.Format = "###,###,##0.00"
        Me.DgvDetallesCyC.Columns(11).DefaultCellStyle.Format = "###,###,##0.00"

        Me.DgvDetallesCyC.Columns(12).DefaultCellStyle.BackColor = Color.Green
    ...
    Private Sub btnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMostrar.Click
                ...
                For y As Integer = Me.txtDesde.Text.Substring(6, 2) To Me.txtHasta.Text.Substring(6, 2)
                    ...
                    For m = mes_inicio To Mes_Fin
                        ...
                        For d = days_desde To days_hasta
                            ...
                            '***************************************CONSULTAS*****************************************
                            sql = New SqlCommand("select b.Fecha, SUM(a.Importe) AS Importe FROM LINEAS_DE_REQUISICIONES a, REQUISICIONES b, PRODUCTOS c WHERE c.IdEtapa='PI' and a.Req_No=b.Req_No and a.Codigo_Producto= c.Codigo_Producto " _
                            ...
                            While leer.Read
                                ...
                                Else
                                    Reemplazoss = leer(0)
                                    dr(13) = Math.Round(Reemplazoss, 2)
                                End If
                            End While
                            con.Close()
                            '****************************************************************************
        ...
        dr(13) = Sumar("Reemplazos", Me.DgvDetallesCyC)
        dr(14) = Sumar("Defuncion", Me.DgvDetallesCyC)
        dr(15) = Sumar("Destazo", Me.DgvDetallesCyC)
        dr(16) = Sumar("Rastro", Me.DgvDetallesCyC)
        dr(17) = Sumar("Entrada", Me.DgvDetallesCyC)
        dr(18) = Sumar("Salida", Me.DgvDetallesCyC)
        dr(19) = CerdosReg
        carrito.Rows.Add(dr)
        ...
        Try
            If Me.ExsitenTraslados = False Then
                ...
                While leer.Read
                    ...
                    Else
                        Me.txtCostoAlNacer.Text = Math.Round(leer(0), 2)
                        Me.CostoNacerU = leer(0) / CerdosReg
                    End If
                End While
                con.Close()
            Else
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX1.Click
        ...
        Else
            ...
            Dim rpt As New Cr_Reporte_x_LoteCostos()
    ...
    Private Sub ButtonX2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX2.Click
        ExportarDatosExcel(Me.DgvDetallesCyC, "Reporte de Consumo Costos", "LOTE NO: " & Me.CbxListaLotes.Text, "REPORTE DEL: " & Me.txtDesde.Text & " AL " & Me.txtHasta.Text, "S")
    End Sub
    Private Sub CbxListaLotes_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CbxListaLotes.TextChanged
