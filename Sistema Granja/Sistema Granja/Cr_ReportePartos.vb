...
Public Class Cr_ReportePartos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Granja.Cr_ReportePartos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ReportePartos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ReportePartos = New Cr_ReportePartos()
        rpt.Site = Me.Site
        Return rpt
    End Function
