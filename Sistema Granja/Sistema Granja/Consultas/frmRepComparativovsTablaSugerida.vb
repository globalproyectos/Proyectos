Public Class frmRepComparativovsTablaSugerida
    ...
    Private Sub frmRepComparativovsTablaSugerida_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
    Sub cargar()
        Try
            RepConsumoSemEngordeAdaoter.Fill(odtsInventario.RepConsumoSemEngorde, desdeDateTimeInput1.Text, hastaDateTimeInput2.Text, "")
