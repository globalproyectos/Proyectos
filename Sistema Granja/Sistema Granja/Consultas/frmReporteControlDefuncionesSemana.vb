Public Class frmReporteControlDefuncionesSemana
    ...
    Private Sub frmReporteControlDefuncionesSemana_Load(sender As Object, e As EventArgs) Handles MyBase.Load
